...
onlyfiles = [f for f in listdir('D:\\Python_class\\Handwritten_and_Printed_Text_Classification\\text_localization_and_classification\\Samples\\C') if isfile(join('D:\\Python_class\\Handwritten_and_Printed_Text_Classification\\text_localization_and_classification\\Samples\\C', f))]
des = 'D:\\Python_class\\Handwritten_and_Printed_Text_Classification\\text_localization_and_classification\\Samples\\D\\'
des2 = 'D:\\Python_class\\Handwritten_and_Printed_Text_Classification\\text_localization_and_classification\\Samples\\E||'
tracker=0
for s in onlyfiles:
	try:
		#s = 'sample6.jpg'
		img = cv2.imread('D:\\Python_class\\Handwritten_and_Printed_Text_Classification\\text_localization_and_classification\\Samples\\C'+s)
		fram = img.copy()
		#if not img.shape():
		#	continue
